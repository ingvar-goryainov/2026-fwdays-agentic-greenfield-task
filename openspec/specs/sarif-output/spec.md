...
SARIF v2.1.0 output for `agents-lint`, letting `internal/reporter.WriteSARIF`
render findings for consumption by CI tooling and code-scanning integrations,
selectable via the `--format` flag alongside the default text reporter.
