...
Packaging and documentation for `agents-lint`: a cross-compiled release build
target producing small, statically-linked binaries for the project's target
platforms, and a project README (`docs/README.md`) covering installation,
CLI usage, the full rule catalog, and the configuration file reference.
